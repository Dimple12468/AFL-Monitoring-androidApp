...
public class completed extends Fragment {
    ...
    private String statusURL,nextURL;
...
//    private TextView textView;
    ...
    public static completed newInstance(int tabCnt) {
...
//        textView = root.findViewById(R.id.dateHeader);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getFragmentManager().beginTransaction().detach(completed.this).attach(completed.this).commit();
            }
        });
...
//                textView.setText("This is ongoing fragment");
                ...
                break;
            case 3:
//                textView.setText("This is completed fargemnt");
